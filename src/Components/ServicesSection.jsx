        ...
        {services.map((service) => (
          ...
          >
            ...
            <div className="md:w-1/2 p-4 flex flex-col justify-start">
              ...
              <button className="self-start cursor-pointer px-3 py-2  text-xs bg-[#C62828] text-white rounded-lg font-semibold hover:bg-[#FBC02D] hover:text-white transition">
                Learn More
              </button>
            </div>
          </div>
