  ...
  return (
    <section className="p-8 bg-white text-center">
      ...
      <p className="max-w-6xl mx-auto text-gray-600 leading-relaxed mb-6">
        ...
        Pakistan, our unwavering commitment to excellence drives everything we do.
      ...
      {/* Button */}
      <button className="px-8 py-3 cursor-pointer  bg-[#C62828] text-white rounded-lg font-semibold hover:bg-[#FBC02D] hover:text-white transition">
        About Us
      </button>
    </section>
  );
